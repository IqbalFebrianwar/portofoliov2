    ...
    <div className="w-full mt-16  grid justify-start">
      <div className="w-full justify-start">
        ...
        <ul className="max-w-3xl space-y-1 mt-2 text-gray-500 list-disc list-inside">
            <li><span className="font-bold text-gray-700">Paket Silver </span>Cocok Untuk Website Sederhana seperti Landing Page dll.</li>
            <li><span className="font-bold text-gray-700">Paket Gold </span>Cocok Untuk yang Membutuhkan Website Untuk Profile Bisnis guna Meningkatkan Online Presence.</li>
            <li><span className="font-bold text-gray-700">Paket Diamond </span>Cocok Untuk yang Membutuhkan Website yang Membutuhkan Storage Besar dan Fitur Khusus yang Lebih Kompleks.</li>
        </ul>
      </div>
